...
export default class UIPopProp extends UIViewPop {
    ...
    onAwake() {
        super.onAwake();
        // this.imageBg = UIFind.FindUI(this.node, "ImageBg2", UIImage,false); 
        // this.imageBg.zOrder = -1; 
...
// return;
        ...
        // var sp =this.node as Laya.Sprite;
        // sp.updateZOrder();
        // this.node.setChildIndex(this.imageBg.node,0);
    ...
    onStart() {
        ...
        // ly.offsetYDown = AdKitCommon.main.
        this.LayOut();
    }
    ...
    OnClickBtnClose() {
        GameData.main.game.ShowProp(false); 
